...
ActiveRecord::Schema.define(:version => 20130107205433) do
  ...
  create_table "refinery_properties_cities", :force => true do |t|
    t.string   "name"
    t.integer  "position"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  create_table "refinery_tenants", :force => true do |t|
    t.string   "name"
    t.integer  "logo_id"
    t.integer  "position"
    t.datetime "created_at",          :null => false
  ...
  create_table "tenant_representations", :force => true do |t|
    t.integer  "broker_id"
    t.integer  "tenant_id"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
